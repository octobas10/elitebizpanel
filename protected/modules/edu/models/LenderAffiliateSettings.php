<?php
/**
 * This is the model class for table "edu_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'edu_lender_affiliate_settings':
 * @property integer $id
 ...
 */
	...
	*/
	 ...
	 ** Modification Date : 02-08-2016
	**/
class LenderAffiliateSettings extends EModuleActiveRecord {
	/**
	...
	public function tableName(){
		return 'edu_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = parent::getDbConnection()->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE edu_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
	...
	/**
	 ** Author : Vatsal Gadhia
	 ** Description : code to get/set Pause Vendor
	 ** Date : 02-08-2016
	**/
	public function setPausevendorResponse($string,$where) {
		$connection = parent::getDbConnection();
		$sql = "UPDATE edu_lender_affiliate_settings SET paused_vendor  = '$val' WHERE lender_details_id=$id";
		$command=$connection->createCommand($sql);
		$command->execute();
