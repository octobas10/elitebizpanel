...
/**
 * This is the model class for table "edu_lender_user".
 *
 * The followings are the available columns in table 'edu_lender_user':
 * @property string $id
 ...
 */
	...
	*/
class LenderUser extends EModuleActiveRecord {
	/**
