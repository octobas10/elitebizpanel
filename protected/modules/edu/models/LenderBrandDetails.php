 ...
 */
class LenderBrandDetails extends EModuleActiveRecord{
	/**
	...
	public function tableName(){
		return 'edu_lender_brand_details';
	}
	/**
	...
	public function rules(){
		...
		return array(
			...
			array(
				'id, lender_id, promo_code, affiliate_transactions_id, customer_id, brand_name, bid_price, date',
				'safe',
				'on' => 'search' 
			) 
		);
