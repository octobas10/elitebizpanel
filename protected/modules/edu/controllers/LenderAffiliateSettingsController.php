...
class LenderAffiliateSettingsController extends Controller{
	...
	public function actionPausevendorAjax(){
		 ...
		 ** Description : query removed from controller and placed in AffiliateUser model (code for Paused Vendor)
		 ** Date : 02-08-2016
		**/
		$o_lender_affiliate_settings = new LenderAffiliateSettings;
		$o_lender_affiliate_settings->unsetAttributes(); // clear any default values
		$val = $o_lender_affiliate_settings->setPausevendorResponse(extract($_REQUEST));
		echo $val;
	}
