...
class XverifyClientAPI {
    ...
    private function email($data) {
        ...
        // $params = array('type' => 'json', 'apikey' => $this->api_key, 'domain' => 'higherlearningapp.com', 'v1' => '', 'v2' => '', 'captcha_status' => '0', 'callback' => 'jQuery22402469638349049722_1480935238606', 'autocorrect' => '0', 'email' => $value, '_' => '1480935238607');
        // print_r($url . '?' . http_build_query($params));
        return 'http://www.xverify.com/services/emails/verify/?type=json&apikey='.$this->api_key.'&domain='.$this->options['domain'].'&v1=&v2=&captcha_status=0&callback=jQuery22402469638349049722_1480935238606&email='.$value.'&autocorrect=0&_=1480935238607';
