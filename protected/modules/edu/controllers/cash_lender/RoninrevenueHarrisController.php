<?php
class RoninrevenueHarrisController extends Controller {
    ...
    public static function sendPostData($parameter1,$parameter2,$parameter3,$ping_response,$post_url,$status){
		...
		$program_model = new ProgramOfInterests();
		$valid_program = $program_model->checkProgramOfInteresetRoninRevenuesHarrisSchool(Yii::app()->request->getParam('program_of_interest'));
		if($valid_program['id']){
		...
		$promo_code = Yii::app()->request->getParam('promo_code');
    	$fields = array(
			'campaign_code' => $parameter1 ? $parameter1 :'K_VzM2P42o4fKlF4UHadXw',
