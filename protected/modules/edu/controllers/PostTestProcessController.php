			...
			if($affiliate_cap){
				...
				foreach($lenderlist as $lender){
					...
					if($lender->ping_url_test!='' || $lender->ping_url_live !='' ){
						...
						$ping_id = $cm->setLenderTransactionLog($lendername,$lenders_response[$lender_id]['ping_price'],$post_request=null,$post_status=null,$post_response=null,$lenders_response[$lender_id]['ping_time'],$lenders_response[$lender_id]['ping_request'],$lenders_response[$lender_id]['ping_status'],$ping_response,$redirect_url=null,$ping_id=null);
				...
				if($Max_Price_Ping_Accepted_Lender['ping_price']!=''){
					...
					$cm->setLenderTransactionLog($lendername,$post_price,$post_request,$post_status,$post_response,$post_time,$ping_request,$ping_responses,$ping_response,$redirect_url,$ping_id);
