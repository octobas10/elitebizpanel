				...
				if(!empty($lenders)){
					foreach($lenders as $lender){
						if($lender->name!=''){
							...
							$cm->setLenderTransactionLog($lendername,$post_response['post_price'],$post_response['post_request'],$post_response['post_status'],$post_response['post_response'],$post_response['post_time'],$ping_request=null,$ping_status=null,$ping_response=null,$post_response['redirect_url'],$lender_trans_id);
