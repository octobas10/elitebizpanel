...
class DemoController extends Controller {
    public static function doConnect($feed_lender_name, $post_string = array(), $parameter1, $parameter2, $parameter3, $posturl, $testurl,$vendor_id) {
    	$fields = array(
		...
		/*$cm->setFeedLenderAcceptRespond ( $feed_lender_name, $post_string, $response, $posturl, $curl_total_time, $status,$vendor_id );*/
		return $status;
    }
}
?>
