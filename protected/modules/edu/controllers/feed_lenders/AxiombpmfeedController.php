<?php
class AxiombpmfeedController extends Controller {
	public static function doConnect($feed_lender_name, $post_string, $parameter1, $parameter2, $parameter3, $posturl, $testurl) {
		$fields = array (
				'clientid' => 117,
				'campaigncode' => 5,
