...
.ui-dialog.ui-widget.ui-widget-content.ui-corner-all.ui-draggable {
    ...
    #lender-affiliate-settings-grid {
        width: 1105px;
        padding: 15px;
    }
    #lender-affiliate-settings-grid th {
        min-width: 80px;
    }
    .table_data .portlet-content {
        padding: 0;
    }
</style>
<?php
...
<div class="row">
	<div class="col-sm-12">
		...
		<div style="height:100%;width:100%;" class="row">
		    <div style="display: inline-block;vertical-align:top; padding-right: 9px;" class="col-sm-3 form-group">
		    	(Only Active Affiliate)
				<?php echo $form->labelEx($model,'affiliate_user_id',array('style'=>'font-weight:bolder')); ?>
				<?php echo $form->dropDownList($model,'affiliate_user_id',$affiliate,array('class'=>'form-control','empty'=>'Select Affiliate')); ?>
				<?php echo $form->error($model,'affiliate_user_id'); ?>
			</div>
		    <div style="display: inline-block;vertical-align:top;padding-right: 9px;" class="col-sm-3 form-group">
				<?php echo $form->labelEx($model,'lender_details_id',array('style'=>'font-weight:bolder')); ?>
				<?php echo $form->dropDownList($model,'lender_details_id',$lender,array('multiple'=>'multiple','class'=>'form-control')); ?>
			...
			<div style="display: inline-block;vertical-align:top;" class="col-sm-3 form-group">
...
<div class="row-fluid table_data">
<div class="span12">
<?php
