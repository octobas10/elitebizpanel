...
<tr>
   <th rowspan="2">Affiliate Name</th>
	...
	<?php if(!empty($posts['postedleads_post_prices'])){?>
	<th colspan="<?php echo count($posts['postedleads_post_prices']);?>" style="text-align: center;">Lead Prices</th>
	<?php }?>
...
<tr>
	<?php foreach($posts['postedleads_post_prices'] as $price){?>
 ...
 * modification date : 22-07-2016 5:45 pm
 -->
<!--<td>-->
	<?php //if(!empty($value['total_ping_sent'])){ ?>
		<!--<a target="_blank" href="<?php //echo Yii::app()->createAbsoluteUrl(Yii::app()->params['campaign']).'/leads/lead_info?posting_type=0&promo_code='.$promo_code.'&start_date='.$start_date.'&end_date='.$end_date;?>"><?php //} //echo $value['total_ping_sent'];?>
		<!--</a></td>-->
	
<!--<td>
	<?php //if(!empty($value['total_ping_accepted'])){ ?>
		<!--<a target="_blank" href="<?php //echo Yii::app()->createAbsoluteUrl(Yii::app()->params['campaign']).'/leads/lead_info?posting_type=0&promo_code='.$promo_code.'&start_date='.$start_date.'&end_date='.$end_date.'&ping_status=1';?>"><?php //} //echo $value['total_ping_accepted'];?>
		<!--</a></td>-->
...
<?php
foreach($posts['postedleads_post_prices'] as $price){
