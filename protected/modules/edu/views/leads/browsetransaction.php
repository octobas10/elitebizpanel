...
<tr>
	...
	<?php echo CHtml::radioButtonList('field',''.$field.'', 
			array('email'=>'Email','first_name' => 'First Name', 'last_name' => 'Last Name', 'ipaddress' => 'IP Address', 'phone' => 'Phone'),	
			array('labelOptions' => array('style'=>'display:inline')));
	?>
	</td>	
...
<?php foreach ($posts as $aff_trans) {?>
	<tr class="post">
		...
		<td>
			...
			<?php if($aff_trans['post_request_affiliate']){?>
			<p><b>Post Request Affiliate</b></p>
			<p style="word-wrap:break-word;width:400px"><?php echo htmlentities($aff_trans['post_request_affiliate']); ?>	</p>
			<?php }?>
