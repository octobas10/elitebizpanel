<h4>Lead Infomation Report for Lender: <?php isset($posts[0]->feed_lender_name) ? print_r($posts[0]['feed_lender_name']) : ''; ?> </h4>
<div class="row-fluid">
	<div class="span12">
		...
		<table class="table table-striped table-hover table-bordered table-condensed">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<p class="comment more" style="word-wrap:break-word;width:200px"><?php echo urldecode($lead_info_report['request']);?></p>
					</td>
					<td>
						<p class="comment more" style="word-wrap:break-word;width:200px"><?php echo htmlentities($lead_info_report['full_response']);?></p>
					</td>
				</tr>
				<?php $i++;
					}
