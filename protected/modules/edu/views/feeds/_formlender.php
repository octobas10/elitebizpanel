...
<div class="portlet-title">Lender Details</div>
</div>
...
?>
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model,'feed_lender_name',array('size'=>60,'maxlength'=>50,'class'=>'form-control','readonly'=>($model->isNewRecord)? false : true)); ?>
		<?php echo $form->error($model,'feed_lender_name'); ?>
	</div>
	
		<div class="form-group">
			<?php echo $form->labelEx($model,'password'); ?>
			<?php echo $form->passwordField($model,'password',array('size'=>60,'maxlength'=>50,'class'=>'form-control')); ?>
			<?php echo $form->error($model,'password'); ?>
		</div>
	<div class="form-group">
		<?php echo $form->labelEx($model,'email'); ?>
		<?php echo $form->textField($model,'email',array('size'=>60,'class'=>'form-control','maxlength'=>100)); ?>
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model,'post_url',array('size'=>60,'class'=>'form-control')); ?>
