...
*/
-->
<title>Higher Learning Marketers Affiliate Ping-Post Instructions</title>
<style type="text/css">
.red_api_navigation {
...
<body>
<div class="red_api_navigation">Higher Learning Marketers Affiliate Portal</div>
<div class="container">
<div class="content">
...
Copyright &copy; <?php echo @date('Y'); ?> by HigherLearningMarketers.com <br/>All Rights Reserved.<br/>
</div><!-- footer -->
</div>
</body>
</html>
