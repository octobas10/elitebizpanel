<?php
	...
	?>
<h4>Lead Infomation Report for Affiliate: <?php echo $aff_data[$posts[0]['promo_code']];?></h4>
<div class="row-fluid">
	<div class="span12">
		...
		<table class="table table-striped table-hover table-bordered table-condensed">
			<thead>
				<tr>
					...
					<!-- 
						/**
						 * @since : 17-11-2016 10:47 AM
						 * @author : Siddharajsinh Maharaul
						 * @functionality : Added column sub_id from edu_affiliate_transactions table
						 */
					 -->
					<th>Sub Id</th>
					<?php 
						/**
						 * @since : 17-11-2016 05:41 PM
						 * @author : Siddharajsinh Maharaul
						 * @functionality : Display reason if report generated for return leads
						 */
						echo (!empty($is_returned) ? '<th>Reason</th>' : '');
					?>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					 ...
					 * modification date : 19-09-2016
					 -->
					<!--<td>
						<p class="comment more" style="word-wrap:break-word;width:200px">-->
							<?php //echo urldecode($lead_info_report['ping_request']);?>
						<!--</p>
					</td>
					<td>
						<p class="comment more" style="word-wrap:break-word;width:200px">-->
							<?php //echo htmlentities($lead_info_report['ping_response']);?>
						<!--</p>
					</td>-->
					<td>
					...
					<!-- 
					 ...
					 -->
					<td>
						<p class="comment more" style="word-wrap:break-word;width:200px"><?php echo htmlentities($lead_info_report['sub_id']);?></p>
					</td>
					<?php 
						/**
						 * @since : 17-11-2016 05:41 PM
						 ...
						 * @functionality : Display reason if report generated for return leads
						 */
						echo (!empty($is_returned) ? '<td>'.$lead_info_report['return_reason'].'</td>' : '');
					?>
				</tr>
				<?php $i++;
					}
...
<script>
	$(document).ready(function(){
	    ...
	    $("#exportcsv").click(function(){
			...
			var symbol = '&';
			/**
			 * @since : 12-12-2016 11:21 AM
			 * @author : Siddharajsinh Maharaul
			 * @functionality : Changed <= condition to < to check length
			 */
