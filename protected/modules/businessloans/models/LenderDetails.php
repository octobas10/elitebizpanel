<?php
/**
 * This is the model class for table "businessloans_lender_details".
 *
 * The followings are the available columns in table 'businessloans_lender_details':
 * @property integer $id
 ...
 */
class LenderDetails extends BusinessloansActive{
	/**   
	...
	public function tableName(){
		return 'businessloans_lender_details';
	}
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE businessloans_lender_details SET paused_vendor  = '$val' WHERE id=$id";
	...
	public function check_acceptCap($lender_id) {
		...
		$cmd = Yii::app()->dbBusinessLoans->createCommand()
			...
			->from('businessloans_lender_details')
	...
	public function check_paused_vendor($lender_id){
		$where = "id= '$lender_id'";
		$array = Yii::app()->dbBusinessLoans->createCommand()
