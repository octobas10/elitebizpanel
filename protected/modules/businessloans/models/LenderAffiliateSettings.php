<?php
/**
 * This is the model class for table "businessloans_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'businessloans_lender_affiliate_settings':
 * @property integer $id
 ...
 */
class LenderAffiliateSettings extends BusinessloansActive{
	/**
	...
	public function tableName(){
		return 'businessloans_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = Yii::app()->dbBusinessLoans->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE businessloans_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
