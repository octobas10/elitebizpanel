 ...
 */
class FeedSubmission extends BusinessloansActive {
    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'businessloans_feed_submission';
    }
    ...
    public function getSubmissionData($delay, $limit, $commit_point) {
        ...
        $feed_submissions = Yii::app()->dbBusinessLoans->createCommand()->select('*')->from('businessloans_feed_submission')->where($where)->limit($limit)->queryAll();
