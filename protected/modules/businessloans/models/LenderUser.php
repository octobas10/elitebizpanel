...
/**
 * This is the model class for table "businessloans_lender_user".
 *
 * The followings are the available columns in table 'businessloans_lender_user':
 * @property string $id
 ...
 */
class LenderUser extends BusinessloansActive{
	/**
	...
	public function tableName(){
		return 'businessloans_lender_user';
	}
