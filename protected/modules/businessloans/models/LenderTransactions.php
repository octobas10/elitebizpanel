<?php
/**
 * This is the model class for table "businessloans_lender_transactions".
 *
 * The followings are the available columns in table 'businessloans_lender_transactions':
 * @property integer $id
 ...
 */
class LenderTransactions extends BusinessloansActive{
	/**
	...
	public function tableName(){
		return 'businessloans_lender_transactions';
	}
	/**
	 *
	...
	public function exit_url($affiliate_trans_id){
		...
		$exiturl = Yii::app()->dbBusinessLoans->createCommand()
		->select('exit_url')
		->from('businessloans_lender_transactions')
		->where($where)
		->queryScalar();
	...
	public function get_Lender_Pigned_With_This_Ping_Id($affiliate_trans_id){
		...
		$dbCommand = Yii::app()->dbBusinessLoans->createCommand()->setFetchMode(PDO::FETCH_OBJ)
		...
		->from('businessloans_lender_transactions a')
		...
		//mail('octobas@gmail.com','businessloans : multiple ping accepted lenders',$qry);
		return $dataReader;
	}
	/**
	...
	public function lender_reports(){
		...
		$rawData1 = Yii::app()->dbBusinessLoans->createCommand()
		...
		->from('businessloans_lender_transactions as a')
		->where($where)
		->group($groupby)
		->order($order)
		->queryAll();
