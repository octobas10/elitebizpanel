...
<div class="row-fluid">
	<div class="span9">
		<?php
			$this->beginWidget('zii.widgets.CPortlet',array('title' => '<span class="icon-picture"></span>Campaign Performance - businessloans / Refinance'));
			if(is_array($leads)){?>
...
<div class="row-fluid">
	<div class="span9">
		...
		$ping_results = AffiliateDailyCounts::specific_affiliate_pingreport_last_15days();
		$post_results = AffiliateDailyCounts::specific_affiliate_postreport_last_15days();
		//echo '<pre>';print_r($ping_results);print_r($post_results);exit;
		$ping_duplicate = 0; $ping_accepted = 0;
		if(isset($ping_results) && !empty($ping_results)) {
			...
			$ping_sent = 0;$ping_duplicate = 0;$ping_accepted = 0;$ping_rejected_pie = 0;
		}
		// ping 3d pie
		$post_duplicate = 0; $post_accepted = 0;
		if(isset($post_results) && !empty($post_results)) {
			...
			$post_sent = 0;$post_duplicate = 0;$post_accepted = 0;$post_rejected_pie = 0;
		}
		?>
