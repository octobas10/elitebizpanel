<?php
class FeedLenderTransactions extends HomeimprovementActive {
    /**
    ...
    public function tableName() {
        return 'homeimprovement_feed_lender_transactions';
    }
    /**
...
//  		echo '<pre>'.$where.'</pre>';exit;
	    ...
	    ->from('homeimprovement_feed_lender_transactions')
		->where($where)
		->order($order)
	    ->queryAll();
	}
