 ...
 */
class FeedSubmission extends HomeimprovementActive {
    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'homeimprovement_feed_submission';
    }
    ...
    public function getSubmissionData($delay, $limit, $commit_point) {
        ...
        $feed_submissions = Yii::app()->dbHomeimprovement->createCommand()->select('*')->from('homeimprovement_feed_submission')->where($where)->limit($limit)->queryAll();
