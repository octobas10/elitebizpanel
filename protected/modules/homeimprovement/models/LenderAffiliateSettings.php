<?php
/**
 * This is the model class for table "homeimprovement_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'homeimprovement_lender_affiliate_settings':
 * @property integer $id
 ...
 */
class LenderAffiliateSettings extends HomeimprovementActive{
	/**
	...
	public function tableName(){
		return 'homeimprovement_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = Yii::app()->dbHomeimprovement->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE homeimprovement_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
