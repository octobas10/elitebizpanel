<?php
class NetwayController extends Controller {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0,$ping_url = null) {
		...
		if($project_type == 45 ){// SOLAR
			...
			$apitoken = $p1 ? $p1 : 'a960ef1d08cc07b00a6fda538d5ad606756fe09b';
			...
			$apitoken = $p2 ? $p2 : '76f0272411722c85b9773f07b0c69b302b0df503';
		}
		$purchase = true;
