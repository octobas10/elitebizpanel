...
class OceanbeachmediaController extends Controller {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0, $ping_url = null) {
		...
		if($project_type == 45 ){// SOLAR
			...
			$apitoken = $p1 ? $p1 : 'cf55665739cac66015567abdddca47431081ed41';
			...
			$apitoken = $p2 ? $p2 : '77f2cff122a2145baf6b9e1bb2fa71cfaf969b52';
		}
		$purchase = true;
    ...
    public static function sendPostData($p1, $p2, $p3, $ping_response, $post_url, $status) {
		...
		if($project_type == 45 ){// SOLAR
			...
			$apitoken = $p2 ? $p2 : '3814b2121261cc39ea2efd1b75f94e5129cddc91';
		}
