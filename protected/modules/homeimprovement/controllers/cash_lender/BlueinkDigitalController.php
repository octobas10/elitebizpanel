<?php
class BlueinkDigitalController extends Controller {
	...
	public static $not_allowed = ['ready4solar.com'];
		...
		if($promo_code != 24){
			...
			$fields = [
				'meta' => [
					...
					'tcpa_compliant' => Yii::app()->request->getParam('tcpa_optin')=='1' ? true : false,
			...
			if($project_type == 45 ){// SOLAR
				...
				//$apitoken = $p1 ? $p1 : 'eb12b418aaa56234a5ce7ad5ed6a1b2d51167333';
				$apitoken = $p1 ? $p1 : '94e23477-6655-4e4b-b76e-8e0276a844ab';
				...
				//$apitoken = $p2 ? $p2 : '314eaf93b64a1afffb4e9ba40d6494ae111e0f21';
				$apitoken = $p2 ? $p2 : '7b6ba207-0b13-4e24-a1e6-f99556f654f9';
			}
			$purchase = true;
			...
			//echo '<pre>';print_r($fields);print_r($pingData);exit;
			return $pingData;
		}
    }
    /**
    ...
    public static function sendPostData($p1, $p2, $p3, $ping_response, $post_url, $status) {
		...
		if($project_type == 45 ){// SOLAR
			...
			//$apitoken = $p1 ? $p1 : 'eb12b418aaa56234a5ce7ad5ed6a1b2d51167333';
			$apitoken = $p1 ? $p1 : '94e23477-6655-4e4b-b76e-8e0276a844ab';
			$post_url = str_replace('home_improvement','solar',$post_url);
		}else{ // HOME IMPROVEMENT
			if(!empty($jangl_project_array)){
				$campaign = [$variable[0] => $jangl_project_array];
				$fields['data'] += $campaign;
