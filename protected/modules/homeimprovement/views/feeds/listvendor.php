...
$buttons = array(
			...
			'buttons'=>array(
				'view'=>
					array(					
						'url'=>'Yii::app()->createUrl("homeimprovement/feeds/viewvendor", array("id"=>$data->id))',								
					),
				'update'=>
					array(
						'url'=>'Yii::app()->createUrl("homeimprovement/feeds/updatevendor", array("id"=>$data->id))',
					),
				'delete'=>
					array(
						'url'=>'Yii::app()->createUrl("homeimprovement/feeds/deletevendor", array("id"=>$data->id))',
					),
			),
		);
?>
