...
?>
			...
			<div class="summary">
				<ul>
					<li>
						...
						<span class="summary-number"><?php //echo number_format($week_submissions); 
														?></span>
						<span class="summary-title">Last 7 Days Submission</span>
						<br>
						<span class="summary-icon"> <img src="<?php echo $baseUrl; ?>/img/group.png" width="36" height="36" alt="Active Members"></span>
						<span class="summary-number"><?php //echo number_format($week_accepted); 
														?></span>
	...
	<div class="row-fluid">
		<div class="span9">
			<?php
			$this->beginWidget('zii.widgets.CPortlet', array('title' => '<span class="icon-picture"></span>Campaign Performance - Home Improvement Finance'));
			if (is_array($leads)) { ?>
					...
					<thead>
						...
						<tr>
							...
							foreach ($affiliates as $vid => $affiliate_name) {
								echo '<th style="text-align:center;" colspan="2">' . $affiliate_name . '(' . $vid . ')</th>';
							}
							?>
						</tr>
						<tr>
