...
<div class="row">
	<?php echo $form->labelEx($model,'minute_submission_cap'); ?>
	<?php echo $form->textField($model,'minute_submission_cap',array('size'=>32,'maxlength'=>32)); ?>
	<?php echo $form->error($model,'minute_submission_cap'); ?>
</div>
<div class="row">
