	...
	<div class="span6 offset3">
		<?php
			$this->beginWidget('zii.widgets.CPortlet', array(
				'title'=>"Buyer Login Into elitehomeimprovers.com Buyer Portal",
			));
			?>
		...
		<div class="register_link">
			Are you a <a href="http://www.elitehomeimprovers.com" target="_blank" class="sitelink">elitehomeimprovers.com</a> Publisher <a href="../affiliates/login" class="affilaite_login"> Click Here</a>
		</div>
		</div>
		<?php $this->endWidget();?>
	</div>
