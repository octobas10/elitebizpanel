...
<p class="title">Elitehomeimprovement Email Creatives:</p>
...
<div class="row display_creatives">
<p class="title">Elitehomeimprovement Email Creatives Subject Lines:</p>
<?php 
...
<div class="row display_creatives">
<p class="title">Elitehomeimprovement Email Creatives From Lines:</p>
<?php
