...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/homeimprovement/graph/submissionLast15Days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/homeimprovement/graph/conversionsoflast15days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/homeimprovement/graph/lendersDailycountAccept");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/homeimprovement/graph/hourlyacceptancerate");
...
<div class="row-fluid">
  <div class="span12">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/homeimprovement/graph/statewiseAcceptance");
