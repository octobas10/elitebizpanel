		...
		<table class="table table-striped table-hover table-bordered table-condensed">
			<tr>
				<td style="width: 100px"><b>Date Range: </b>
					...
					?>
					<span style="margin-right:16px;">Promo code</span><span>Tier</span><br>
					<?php echo CHtml::textField('promo_code','', array('style'=>'width:62px;')); ?>
					<?php echo CHtml::textField('ping_price','', array('style'=>'width:62px;')); ?>
				</td>
