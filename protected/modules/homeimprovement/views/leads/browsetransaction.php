...
$homeimprovement_lead_type = Yii::app()->getRequest()->getParam('homeimprovement_lead_type');
...
<tr>
	...
	<?php
		...
		echo Chtml::listBox('project_type', ''.$project_type. '',
				CHtml::listData(Projects::model()->findAll(),'project_id','project_type'),
				array('empty'=>'-All Projects-','style'=>'width:150px'));
	?>
	</td>
