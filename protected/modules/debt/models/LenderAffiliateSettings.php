<?php
/**
 * This is the model class for table "debt_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'debt_lender_affiliate_settings':
 * @property integer $id
 ...
 */
class LenderAffiliateSettings extends DebtActive{
	/**
	...
	public function tableName(){
		return 'debt_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = Yii::app()->dbDebt->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE debt_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
