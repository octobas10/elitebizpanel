 ...
 */
class FeedSubmission extends DebtActive {
    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'debt_feed_submission';
    }
    ...
    public function getSubmissionData($delay, $limit, $commit_point) {
        ...
        $feed_submissions = Yii::app()->dbDebt->createCommand()->select('*')->from('debt_feed_submission')->where($where)->limit($limit)->queryAll();
