...
/**
 * This is the model class for table "debt_lender_user".
 *
 * The followings are the available columns in table 'debt_lender_user':
 * @property string $id
 ...
 */
class LenderUser extends DebtActive{
	/**
