...
<?php if(isset($last_inserted_id) && $last_inserted_id!=''){?>
	...
	<p>If you have any questions feel free to email <a href="mailto:support@elitedebtcleaners.com">support@elitedebtcleaners.com</a> or call 718 938 1203.</p>
...
<?php }else{
	...
	<div class="row">
        ...
        I have read and agree to the elitedebtcleaners.com's <a href="../default/privacy" target="_blank" class="errorMessage">Privacy Policy</a>, <a href="../default/websiteterm" target="_blank" class="errorMessage">Website Terms</a> & <a href="../default/agreement" target="_blank" class="errorMessage">Affiliate Terms Agreement</a> and also confirm that I am at least 18 years of age.<br><br>
	</div>
