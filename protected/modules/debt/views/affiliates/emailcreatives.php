...
<p class="title">elitedebtcleaners Email Creatives:</p>
...
<div class="row display_creatives">
<p class="title">elitedebtcleaners Email Creatives Subject Lines:</p>
<?php 
...
<div class="row display_creatives">
<p class="title">elitedebtcleaners Email Creatives From Lines:</p>
<?php
