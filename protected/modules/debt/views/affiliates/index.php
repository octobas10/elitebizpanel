...
$this->widget('zii.widgets.grid.CGridView',array(
	...
	'columns' => array(
		...
		array(
			'name' => 'user_name',
			'value' => 'CHtml::link($data->user_name, "http://www.elitedebtcleaners.com?promo_code=".$data->id, array("target" => "_blank","style" => "border-bottom: dashed 1px #0088cc; text-decoration:none;"))',
			'type' => 'raw'
		),
		array(
