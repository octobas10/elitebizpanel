...
$buttons = array(
			...
			'buttons'=>array(
				'view'=>
					array(					
						'url'=>'Yii::app()->createUrl("debt/feeds/viewvendor", array("id"=>$data->id))',								
					),
				'update'=>
					array(
						'url'=>'Yii::app()->createUrl("debt/feeds/updatevendor", array("id"=>$data->id))',
					),
				'delete'=>
					array(
						'url'=>'Yii::app()->createUrl("debt/feeds/deletevendor", array("id"=>$data->id))',
					),
			),
		);
?>
