...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/debt/graph/submissionLast15Days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/debt/graph/conversionsoflast15days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/debt/graph/lendersDailycountAccept");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/debt/graph/hourlyacceptancerate");
...
<div class="row-fluid">
  <div class="span12">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/debt/graph/statewiseAcceptance");
