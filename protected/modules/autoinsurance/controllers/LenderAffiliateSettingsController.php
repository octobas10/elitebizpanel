...
class LenderAffiliateSettingsController extends Controller{
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE autoinsurance_lender_affiliate_settings SET paused_vendor  = '$val' WHERE lender_details_id=$id";
		$command=$connection->createCommand($sql);
		$command->execute();
		$sql2 = "UPDATE autoinsurance_lender_details SET paused_vendor  = '$val' WHERE id=$id";
