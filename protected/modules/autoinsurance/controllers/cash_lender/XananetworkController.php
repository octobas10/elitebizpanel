...
class XananetworkController extends Controller {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
        $pingData = array();
        $p1 = $p1 ? $p1 : 'stMWOtkbOtGiOtqzOiYxXivxSgp_stYxsRqzO5S1stk4S8pW91HuOgc4';
        $p2 = $p2 ? $p2 : 'pingPostLead';
        $p3 = $p3 ? $p3 : '22';
		...
		$request ='<?xml version="1.0" encoding="utf-8"?>
			...
			/*$request ='<?xml version="1.0" encoding="utf-8"?>
			<Request>
			  <Key>stMWOtkbOtGiOtqzOiYxXivxSgp_stYxsRqzO5S1stk4S8pW91HuOgc4</Key>
			  <API_Action>pingPostLead</API_Action>
			  <Mode>ping</Mode>
			  <TYPE>22</TYPE>
			  <Return_Best_Price>1</Return_Best_Price>
			  <Redirect_URL>http://bestquotes.com</Redirect_URL>
			  <Data>
				<IP_Address>104.128.136.114</IP_Address>
				<SRC>Elite_AI</SRC>
				<Sub_ID>512_405_8385_558</Sub_ID>
				<Pub_ID>1</Pub_ID>
				<Unique_Identifier>130</Unique_Identifier>
			 </Data>
		</Request>';*/
		...
		$request ='<?xml version="1.0" encoding="utf-8"?>
			<Request>
			  ...
			  <Data>
				...
				<TCPA_Language>'.$TCPAText.'</TCPA_Language>
				<LeadiD_Token>'.$UniversalLeadID.'</LeadiD_Token>
				<Driver_1_Address></Driver_1_Address>
