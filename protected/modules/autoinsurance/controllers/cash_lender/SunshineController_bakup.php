...
class SunshineController extends Controller {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
		...
		$TCPAOptin = Yii::app()->request->getParam('tcpa_optin','No');
		...
		$vehicle_comprehensiveDeductible=Yii::app()->request->getParam('vehicle_comprehensiveDeductible','4');
		...
		$request ='<?xml version="1.0" encoding="utf-8"?>
			...
			<Vehicle_1_Vin>'.Yii::app()->request->getParam('vehicle1_vin','1ACBC535*B*******').'</Vehicle_1_Vin>
			...
			if (Yii::app()->request->getParam('vehicle2_year')) {
				...
				<Vehicle_2_Vin>'.Yii::app()->request->getParam('vehicle2_vin').'</Vehicle_2_Vin>
			...
			/*$request .='
			  <Matches>
				<Match ValueType="email" HashType="md5">'.md5($partner_email).'</Match>
			  </Matches>
			  <Match_With_Partner_Hashes>
				<Selected_Partner_Hash ValueType="company" HashType="md5">'.md5($partner_company).'</Selected_Partner_Hash>
			  </Match_With_Partner_Hashes>';*/
			$request .='</Request>';
		...
		/*$request ='<?xml version="1.0" encoding="utf-8"?>
					<Request>
						...
						<IP_Address>75.2.92.149</IP_Address>
						<Origination_Datetime>12/23/1980 08:12:11</Origination_Datetime>
						<Origination_Timezone>EST / EDT</Origination_Timezone>
						<TCPA_Optin>Yes</TCPA_Optin>
						<TCPA_Text>TCPA_Text</TCPA_Text>
						<Universal_Leadid>Universal_Leadid</Universal_Leadid>
						<Zip>60610</Zip>
						<Bankruptcy>Yes</Bankruptcy>
						<Credit_Rating>Excellent</Credit_Rating>
						<Have_Insurance>Yes</Have_Insurance>
						<Continuously_Insured_Period>Less than 6 Months</Continuously_Insured_Period>
						<Current_Policy_Start_Date>12/23/1980 08:12:11</Current_Policy_Start_Date>
						<Current_Policy_Expiration_Date>12/23/1980 08:12:11</Current_Policy_Expiration_Date>
						<Coverage_Type>Superior</Coverage_Type>
						<Insurance_Company>Company Not Listed</Insurance_Company>
						<Residence_Type>Own</Residence_Type>
						<Years_At_Residence>0 Years</Years_At_Residence>
						<Months_At_Residence>0 Months</Months_At_Residence>
						<Driver1_DOB>12/23/1980</Driver1_DOB>
						<Driver1_Age>37</Driver1_Age>
						<Driver1_Gender>Male</Driver1_Gender>
						<Driver1_Marital_Status>Single</Driver1_Marital_Status>
						<Driver1_Occupation>Accounts Pay/Rec.</Driver1_Occupation>
						<Driver1_Education>Less than High School</Driver1_Education>
						<Driver1_Required_SR22>SR22 NOT required</Driver1_Required_SR22>
						<Vehicle1_Collision_Deductible>$0</Vehicle1_Collision_Deductible>
						<Vehicle1_Comprehensive_Deductible>$0</Vehicle1_Comprehensive_Deductible>
						<Vehicle1_Year>2018</Vehicle1_Year>
						<Vehicle1_Make>Vehicle1_Make</Vehicle1_Make>
						<Vehicle1_Model>Vehicle1_Model</Vehicle1_Model>
						<Vehicle1_Sub_Model>Vehicle1_Sub_Model</Vehicle1_Sub_Model>
						<Vehicle1_Annual_Mileage>1 to 5,000 miles</Vehicle1_Annual_Mileage>
						<Vehicle1_Daily_Mileage>up to 3 miles</Vehicle1_Daily_Mileage>
						<Vehicle1_Primary_Use>Business</Vehicle1_Primary_Use>
						<Vehicle1_Vehicle_Ownership>Owned</Vehicle1_Vehicle_Ownership>
					</Request>';*/
    ...
    public static function sendPostData($parameter1, $parameter2, $parameter3, $ping_response, $post_url, $status) {
		...
		$request ='<?xml version="1.0" encoding="utf-8"?>
			<Request>
				...
				<Vehicle_2_Model>'.Yii::app()->request->getParam('vehicle2_model').'</Vehicle_2_Model>
				<Vehicle_2_Sub_Model>'.Yii::app()->request->getParam('vehicle2_submodel').'</Vehicle_2_Sub_Model>
				<Vehicle_2_Vin>'.Yii::app()->request->getParam('vehicle2_vin','1ACBC535*B*******').'</Vehicle_2_Vin>
				<Vehicle_2_Ownership>'.$vehicle2_vehicle_ownership.'</Vehicle_2_Ownership>
				<Vehicle_2_Primary_Use>'.self::$PrimaryUsage[Yii::app()->request->getParam('vehicle2_primary_use')].'</Vehicle_2_Primary_Use>
				<Vehicle_2_Average_One_Way_Mileage>'.self::$PrimaryUsage[Yii::app()->request->getParam('vehicle2_primary_use')].'</Vehicle_2_Average_One_Way_Mileage>
				<Vehicle_2_Annual_Mileage>'.self::$vehicleDailyMileage[Yii::app()->request->getParam('vehicle2_annual_mileage')].'</Vehicle_2_Annual_Mileage>
