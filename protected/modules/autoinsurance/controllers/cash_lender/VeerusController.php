...
class VeerusController {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
        ...
        if($promo_code !== '44'){
            ...
            $meta = array(
                ...
                'source_id' => $promo_code, //required
                'offer_id' => $promo_code, //optional
            ...
            $authToken = $p2 ? $p2 : 'e74685ca82f35cd0ea44976e96992bd71bb3a894';
    ...
    //  preg_match("/<Confirmation>(.*)<\/Confirmation>/msui", $ping_response, $confirmation_id);
        ...
        $authToken = $parameter2 ? $parameter2 : 'e74685ca82f35cd0ea44976e96992bd71bb3a894';
        $header = array(
            "authorization: Token $authToken",
            "content-type: application/json",
        );
