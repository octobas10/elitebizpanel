...
<?php if(isset($last_inserted_id) && $last_inserted_id!=''){?>
	...
	<p> Thanks for applying to become an affiliate for Elite Insurers - Auto Insurance.</p>
	...
	<p>IIf you have any questions feel free to email support@eliteinsurers.com or call 718 938 1203.</p>
	<p>Have a great day! 
	   Sincerely,
	   EliteInsurers.com - We Simplify Auto Insurance
	</p>
	</div>
<?php }else{
	...
	<div class="row">
        ...
        I have read and agree to the EliteInsurers.com's <a href="../default/privacy" target="_blank" class="errorMessage">Privacy Policy</a>, <a href="../default/websiteterm" target="_blank" class="errorMessage">Website Terms</a> & <a href="../default/agreement" target="_blank" class="errorMessage">Affiliate Terms Agreement</a> and also confirm that I am at least 18 years of age.<br><br>
	</div>
