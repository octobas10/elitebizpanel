...
<p class="title">EliteInsurers Email Creatives:</p>
...
<div class="row display_creatives">
<p class="title">EliteInsurers Email Creatives Subject Lines:</p>
<?php 
...
<div class="row display_creatives">
<p class="title">EliteInsurers Email Creatives From Lines:</p>
<?php
