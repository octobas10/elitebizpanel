...
<div class="row-fluid">
	<div class="span12">
		<div class="searched_data">
			...
			?>
			<p>Date: <?php echo $sdate .' to  '.$edate ?></p>
			<?php
				$txt = $exportcsv = '';
		...
		<table class="table table-striped table-hover table-bordered table-condensed">
			...
			<tbody>
				...
				<tr>
					<td>
						<p><?php echo $lead_info_report['id'];?></p>
					</td>
					<td>
					...
					<td>
						<p class="comment more" style="word-wrap:break-word;width:20px"><?php echo htmlentities($lead_info_report['ping_price']);?></p>
					</td>
					<td>
					...
					<td>
						<p class="comment more" style="word-wrap:break-word;width:20px"><?php echo htmlentities($lead_info_report['post_price']);?></p>
					</td>
				</tr>
				<?php $i++;
					}
