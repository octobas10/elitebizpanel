...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/autoinsurance/graph/submissionLast15Days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/autoinsurance/graph/conversionsoflast15days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/autoinsurance/graph/lendersDailycountAccept");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/autoinsurance/graph/hourlyacceptancerate");
...
<div class="row-fluid">
  <div class="span12">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/autoinsurance/graph/statewiseAcceptance");
