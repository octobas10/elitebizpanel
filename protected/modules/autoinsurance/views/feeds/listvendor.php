...
$buttons = array(
			...
			'buttons'=>array(
				'view'=>
					array(					
						'url'=>'Yii::app()->createUrl("autoinsurance/feeds/viewvendor", array("id"=>$data->id))',								
					),
				'update'=>
					array(
						'url'=>'Yii::app()->createUrl("autoinsurance/feeds/updatevendor", array("id"=>$data->id))',
					),
				'delete'=>
					array(
						'url'=>'Yii::app()->createUrl("autoinsurance/feeds/deletevendor", array("id"=>$data->id))',
					),
			),
		);
?>
