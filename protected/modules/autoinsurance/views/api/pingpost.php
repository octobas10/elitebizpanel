...
<table border="0" cellspacing="0" class="data">
    ...
    <tbody>
        ...
        <tr style="background:#EAF1F3;">
            ...
            <td>Driver1's current insurance company <a href="#current_insurance_company"> Appendix : Auto Insurance Companies</a><br>
...
<!--        <tr>
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>driver1_hasTAVCs</strong> = <strong>1</strong> then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>driver1_incident1_type</strong> = <strong>1</strong> (Ticket) then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>driver1_incident1_type</strong> = <strong>2</strong> (Accident) then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>driver1_incident1_type</strong> = <strong>3</strong> (Violation) then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>driver1_incident1_type</strong> = <strong>4</strong> (Claim) then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#EAF1F3;">
            <td class="mono">ticket2_description</td>
            <td>Driver1 Ticket1 Description<br>
                <a href="#driver_ticket1Description">Appendix : Driver Ticket Description </a></td>
        ...
        <tr style="background:#EAF1F3;">
            <td class="mono">driver1_incident4_date</td>
            <td>Date of Driver1 Incident1, in the format YYYY-MM-DD<br>
                <strong style="color:red;">Note: Must be a past date</strong></td>
...
<!--        <tr>
        ...
        <tr style="background:#666;">
            ...
            <td>The year of vehicle1.<br>
                From last 30 years, i.e. between <?php echo date('Y')-20 ?> and <?php echo date('Y')?>, inclusive.<br>
                Note that <?php echo date('Y')+1 ?> would be acceptable from August, <?php echo date('Y')?></td>
...
<code style="height: 9.5em;">
    PING URL: https://elitebizpanel.com/autoinsurance/pingprocess<br>
    Accept: text/html<br>
    Content-Type: application/x-www-form-urlencoded<br>
    <br>
    <?php $promo_code = isset($promo_code) ? $promo_code : '123'; ?>
	lead_mode=1&nbsp;promo_code=<?php echo $promo_code; ?>&nbsp;sub_id=512_405_6551_-ID&nbsp;tcpa_optin=1&nbsp;tcpa_text=By clicking Get My Quotes, I agree to the Terms of Service and Privacy Policy......&nbsp;ipaddress=107.150.30.112&nbsp;user_agent=Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36&nbsp;vendor_lead_id=667597661&nbsp;zip=22942&nbsp;is_rented=rent&nbsp;stay_in_year=1&nbsp;stay_in_month=0&nbsp;credit_rating=1&nbsp;bankruptcy=0&nbsp;coverage_type=2&nbsp;vehicle_deductibles=5&nbsp;vehicle_collision_deductibles=5&nbsp;url=http://eliteinsurer.com/&nbsp;medical_pay=5&nbsp;insurance_policy=1&nbsp;universal_leadid=B900B2E2-770A-2E4D-007C-07A8488AE963&nbsp;insurance_company=1&nbsp;insurance_start_date=2018-05-01&nbsp;insurance_expiration_date=2019-06-01&nbsp;continuously_insured_period=2&nbsp;driver1_gender=M&nbsp;driver1_marital_status=1&nbsp;driver1_dob=1992-07-06&nbsp;driver1_education=4&nbsp;driver1_occupation=74&nbsp;driver1_required_SR22=0&nbsp;driver1_hasTAVCs=0&nbsp;vehicle1_year=2015&nbsp;vehicle1_make=CHEVROLET&nbsp;vehicle1_model=Silverado 1500 High Country&nbsp;vehicle1_submodel=4X2 Pickup 4 DOOR - 5.3L V8 G&nbsp;vehicle1_primary_use=2&nbsp;vehicle1_vehicle_ownership=1&nbsp;vehicle1_daily_mileage=2&nbsp;vehicle1_annual_mileage=4&nbsp;vehicle1_vin=3GCPCTEC0F0000000
</code>
...
<h3>Example Request</h3>
<code style="height: 9.5em;">
    POST URL: https://elitebizpanel.com/autoinsurance/pingpostprocess<br>
    Accept: text/html<br>
    Content-Type: application/x-www-form-urlencoded; charset=utf-8<br>
    <br>
    lead_mode=1&nbsp;promo_code=<?php echo $promo_code; ?>&nbsp;sub_id=512_405_6551_-ID&nbsp;tcpa_optin=1&nbsp;tcpa_text=By clicking Get My Quotes, I agree to the Terms of Service and Privacy Policy.....&nbsp;ipaddress=107.150.30.112&nbsp;user_agent=Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36&nbsp;vendor_lead_id=667597661&nbsp;zip=22942&nbsp;is_rented=rent&nbsp;stay_in_year=1&nbsp;stay_in_month=0&nbsp;credit_rating=1&nbsp;bankruptcy=0&nbsp;coverage_type=2&nbsp;vehicle_deductibles=5&nbsp;vehicle_collision_deductibles=5&nbsp;url=http://eliteinsurer.com/&nbsp;medical_pay=5&nbsp;insurance_policy=1&nbsp;universal_leadid=B900B2E2-770A-2E4D-007C-07A8488AE963&nbsp;ping_id=11111&nbsp;address=4273 Columbia road&nbsp;phone=4349608961&nbsp;email=bll6u@virginia.edu&nbsp;insurance_company=1&nbsp;insurance_start_date=2018-05-01&nbsp;insurance_expiration_date=2019-06-01&nbsp;continuously_insured_period=2&nbsp;driver1_first_name=Brandon&nbsp;driver1_last_name=Ladd&nbsp;driver1_gender=M&nbsp;driver1_marital_status=1&nbsp;driver1_dob=1992-07-06&nbsp;driver1_education=4&nbsp;driver1_occupation=74&nbsp;driver1_required_SR22=0&nbsp;driver1_hasTAVCs=0&nbsp;vehicle1_year=2015&nbsp;vehicle1_make=CHEVROLET&nbsp;vehicle1_model=Silverado 1500 High Country&nbsp;vehicle1_submodel=4X2 Pickup 4 DOOR - 5.3L V8 G&nbsp;vehicle1_primary_use=2&nbsp;vehicle1_vehicle_ownership=1&nbsp;vehicle1_daily_mileage=2&nbsp;vehicle1_annual_mileage=4&nbsp;vehicle1_vin=3GCPCTEC0F0000000
