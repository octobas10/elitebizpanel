...
<tr>
	...
	<?php echo CHtml::radioButtonList('field',''.$field.'', 
			array('email'=>'Email','driver1_last_name' => 'First Name', 'driver1_last_name' => 'Last Name', 'ipaddress' => 'IP Address', 'ssn' => 'SS#'),	
			array('labelOptions' => array('style'=>'display:inline')));
	?>
	</td>	
...
foreach ($posts as $sub_leads) { ?>
	...
	<td><?php echo urldecode($sub_leads['driver1_first_name']);?></td>
	<td><?php echo urldecode($sub_leads['driver1_last_name']);?></td>
