<?php
/**
 * This is the model class for table "autoinsurance_lender_details".
 *
 * The followings are the available columns in table 'autoinsurance_lender_details':
 * @property integer $id
 ...
 */
class LenderDetails extends autoInsuranceActive{
	/**   
	...
	public function tableName(){
		return 'autoinsurance_lender_details';
	}
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE autoinsurance_lender_details SET paused_vendor  = '$val' WHERE id=$id";
	...
	public function check_acceptCap($lender_id) {
		...
		$cmd = Yii::app()->dbAutoinsurance->createCommand()
			->select('submission_cap,accepted_cap,hourly_submission_cap')
			->from('autoinsurance_lender_details')
	...
	public function check_paused_vendor($lender_id){
		$where = "id= '$lender_id'";
		$array = Yii::app()->dbAutoinsurance->createCommand()
