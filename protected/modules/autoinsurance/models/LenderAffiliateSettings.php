<?php
/**
 * This is the model class for table "autoinsurance_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'autoinsurance_lender_affiliate_settings':
 * @property integer $id
 ...
 */
class LenderAffiliateSettings extends autoInsuranceActive{
	/**
	...
	public function tableName(){
		return 'autoinsurance_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = Yii::app()->dbAutoinsurance->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE autoinsurance_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
