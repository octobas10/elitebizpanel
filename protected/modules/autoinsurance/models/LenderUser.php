...
/**
 * This is the model class for table "autoinsurance_lender_user".
 *
 * The followings are the available columns in table 'autoinsurance_lender_user':
 * @property string $id
 ...
 */
class LenderUser extends autoInsuranceActive{
	/**
	...
	public function tableName(){
		return 'autoinsurance_lender_user';
	}
