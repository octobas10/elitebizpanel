<?php
/**
 * This is the model class for table "autoinsurance_lender_transactions".
 *
 * The followings are the available columns in table 'autoinsurance_lender_transactions':
 * @property integer $id
 ...
 */
class LenderTransactions extends autoInsuranceActive{
	/**
	...
	public function tableName(){
		return 'autoinsurance_lender_transactions';
	}
	/**
	 *
	...
	public function browselendertransction(){
		...
		->select('id,lender_name,date,ping_request,ping_response,ping_status,ping_price,post_request,post_response,post_status,post_price')
	...
	public function exit_url($affiliate_trans_id){
		...
		$exiturl = Yii::app()->dbAutoinsurance->createCommand()
		->select('exit_url')
		->from('autoinsurance_lender_transactions')
		->where($where)
		->queryScalar();
	...
	public function get_Lender_Pigned_With_This_Ping_Id($affiliate_trans_id){
		...
		$dbCommand = Yii::app()->dbAutoinsurance->createCommand()->setFetchMode(PDO::FETCH_OBJ)
		...
		->from('autoinsurance_lender_transactions a')
		->join('autoinsurance_lender_details b', 'a.lender_name = b.name')
		...
		//mail('octobas@gmail.com','Auto Insurance : multiple ping accepted lenders',$qry);
		return $dataReader;
	}
	/**
	...
	public function lender_reports(){
		...
		$rawData1 = Yii::app()->dbAutoinsurance->createCommand()
		...
		->from('autoinsurance_lender_transactions as a')
		->where($where)
		->group($groupby)
		->order($order)
		->queryAll();
	...
	public function lender_reports_submission(){
		...
		->from('autoinsurance_submissions as a')
		->where($where)
		->group($groupby)
		->order($order)
		->queryAll();
