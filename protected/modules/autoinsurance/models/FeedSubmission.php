 ...
 */
class FeedSubmission extends autoInsuranceActive {
    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'autoinsurance_feed_submission';
    }
    ...
    public function getSubmissionData($delay, $limit, $commit_point) {
        ...
        $feed_submissions = Yii::app()->dbAutoinsurance->createCommand()->select('*')->from('autoinsurance_feed_submission')->where($where)->limit($limit)->queryAll();
