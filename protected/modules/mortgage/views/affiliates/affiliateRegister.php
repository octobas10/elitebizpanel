...
<?php if(isset($last_inserted_id) && $last_inserted_id!=''){?>
	...
	<p> Thanks for applying to become an affiliate for Elite Mortgage Finder – Mortgage & Refinance.</p>
	...
	<p>If you have any questions feel free to email support@elitemortgagefinder.com or call 718 938 1203.</p>
	<p>Have a great day! Sincerely, EliteMortgageFinder.com - We Simplify Your Finances </p>
	</div>
<?php }else{
	...
	<div class="row">
        ...
        I have read and agree to the elitemortgagefinder.com's <a href="../default/privacy" target="_blank" class="errorMessage">Privacy Policy</a>, <a href="../default/websiteterm" target="_blank" class="errorMessage">Website Terms</a> & <a href="../default/agreement" target="_blank" class="errorMessage">Affiliate Terms Agreement</a> and also confirm that I am at least 18 years of age.<br><br>
	</div>
