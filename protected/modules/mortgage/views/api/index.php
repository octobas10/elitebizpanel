...
<table class="data" border="0" cellspacing="0">
    ...
    <tbody>
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>mortgage_lead_type</strong> = <strong>1</strong> then these fields are mandatory</h3></td>
        </tr>
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>mortgage_lead_type</strong> = <strong>2</strong> then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>mortgage_lead_type</strong> = <strong>3</strong> then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
        ...
        <tr style="background:#666;">
            <td class="mono" colspan="3"><h3>If <strong>mortgage_lead_type</strong> = <strong>4</strong> then these fields are mandatory</h3></td>
        </tr>
        <tr style="background:#EAF1F3;">
            <td class="mono">first_balance</td>
            <td>Balance of first mortgage, Should not contain [$,commmas or decimals]<br></td>
