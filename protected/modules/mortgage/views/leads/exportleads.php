...
<td><b>Response :</b><br>
<?php
echo CHtml::radioButtonList('status',$status,array('-1' => 'ANYTHING', '1' => ACCEPTED, '0' => REJECTED),array('empty' => 'ANYTHING','labelOptions'=>array('style'=>'display:inline')));
?>
</td>
<td><b>Gender :</b><br>
<?php
echo CHtml::radioButtonList('gender',$gender,array('-1' => 'ANYTHING', '1' => 'Male', '0' => 'Female'),array('empty' => 'ANYTHING','labelOptions'=>array('style'=>'display:inline')));
?>
</td>
...
<?php echo CHtml::dropDownList('fields[]',$fields,Yii::app()->params['field'],array('multiple'=>'true','size'=>'8')); ?>
</td>
</tr>
<tr>
<td colspan="5">&nbsp;
...
<?php
$this->endWidget();
if(isset($NoDataFound)){ echo '<div class="nodatafound"><p>No data found for this criteria.</p></div>'; }
$this->endWidget();
?>
</div>
</div>
