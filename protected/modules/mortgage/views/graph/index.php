...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/mortgage/graph/submissionLast15Days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/mortgage/graph/conversionsoflast15days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/mortgage/graph/lendersDailycountAccept");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/mortgage/graph/hourlyacceptancerate");
...
<div class="row-fluid">
  <div class="span12">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/mortgage/graph/statewiseAcceptance");
