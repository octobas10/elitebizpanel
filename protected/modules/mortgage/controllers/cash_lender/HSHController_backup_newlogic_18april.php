    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
        ...
        if($mort_type == 'NEWHOME'){
            ...
            if($promo_code == '2' OR $sub_id == '35_2623'){
                $tier15_cap_count = $submission_model->check_accept_by_lender($class_name,$Mortgage_Type,'15.000',$promo_code);
                if($tier15_cap_count < 25){
            ...
            }else if($sub_id == '968_175' OR $sub_id=='20_702750' OR $sub_id=='24_33' OR $promo_code == '35'){
                $tier15_cap_count = $submission_model->check_accept_by_lender($class_name,$Mortgage_Type,'15.000');
            ...
            if(!in_array($state,$state_included)){
                ...
                $ping_response = 'Daily Cap 150 Met for'.$mort_type;
                $purchase = false;
            }else if($loan_amount < 150000){
