...
/**
 * This is the model class for table "mortgage_lender_user".
 *
 * The followings are the available columns in table 'mortgage_lender_user':
 * @property string $id
 ...
 */
class LenderUser extends MortgageActive{
	/**
