<?php
/**
 * This is the model class for table "mortgage_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'mortgage_lender_affiliate_settings':
 * @property integer $id
 ...
 */
class LenderAffiliateSettings extends MortgageActive{
	/**
	...
	public function tableName(){
		return 'mortgage_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = Yii::app()->dbMortgage->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE mortgage_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
