<?php
/**
 * This is the model class for table "mortgage_lender_details".
 *
 * The followings are the available columns in table 'mortgage_lender_details':
 * @property integer $id
 ...
 */
class LenderDetails extends MortgageActive{
	/**   
	...
	public function tableName(){
		return 'mortgage_lender_details';
	}
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE mortgage_lender_details SET paused_vendor  = '$val' WHERE id=$id";
	...
	public function check_paused_vendor($lender_id){
		$where = "id= '$lender_id'";
		$array = Yii::app()->dbMortgage->createCommand()
