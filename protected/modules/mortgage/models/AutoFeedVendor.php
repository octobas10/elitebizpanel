...
/**
 * This is the model class for table "mortgage_feed_vendor".
 *
 * The followings are the available columns in table 'mortgage_feed_vendor':
 * @property integer $id
 ...
 */
class AutoFeedVendor extends MortgageActive {
    /**
     * @return string the associated database table name
     */
    public function tableName(){
        return 'mortgage_feed_vendor';
    }
    /**
    ...
    public function listfeedbrowseleads(){
        ...
        $rawData = Yii::app()->dbMortgage->createCommand()->select($string)->from('mortgage_feed_submission a_sub')->join('mortgage_feed_vendor_transactions a_ft', 'a_sub.id=a_ft.customer_id')->join('mortgage_feed_vendor a_afu', 'a_ft.feed_vendor_id  = a_afu.id')->join('mortgage_feed_lender_transactions a_lts', 'a_lts.feed_vendor_transactions_id   =  a_ft.id')->where($where)->queryAll();
        return $rawData;
    }
    ...
    public function listfeedbrowseallleads(){
        ...
        //echo Yii::app()->dbMortgage->get_query();exit;
        return $rawData;
    }
