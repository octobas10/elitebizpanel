...
class TurtleLeadsController extends Controller {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
        ...
        if($age < '65'){
            $lp_campaign_id = $p1 ? $p1 :'630fa996edace';//health
            $lp_campaign_key = $p2 ? $p2 :'VDpYtTZbcfmRjrLvdFyN';
        }else{
            $lp_campaign_id = $p1 ? $p1 :'630fa9a45cbcb';//medicare
            $lp_campaign_key = $p2 ? $p2 :'wQL7pK2Pc4TyrxmnCNzt';
        }
		$fields = array(
