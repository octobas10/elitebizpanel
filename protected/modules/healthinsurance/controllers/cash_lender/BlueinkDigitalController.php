...
class BlueinkDigitalController extends Controller {
    ...
    public static $not_allowed = ['equoto.com','insurancechiefs.com','somewebsite.com','jangl.com','form.quotewizard.com','quotewizard.com'];
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
		...
		$house_hold_income = (int) Yii::app()->request->getParam('income');
		$house_hold_income = $house_hold_income < 5000 ? 5000 : $house_hold_income; 
		...
		$fields = [
		    ...
		    'contact' => [
   			...
   			'data'=> [
				...
				'household_income'=> $house_hold_income,
				'hospitalized'=> false,
		...
		if($age < '65'){
			$apitoken = 'afe6664609ec986f472334cbf313754713cd485d';  //Health U65
		}else{
			$apitoken = '9ac79a858f929f74a6e98f31986f15a48b684ed0';  //Medicare
		}
		$purchase = true;
