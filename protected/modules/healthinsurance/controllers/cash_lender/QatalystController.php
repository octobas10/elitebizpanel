<?php
class QatalystController extends Controller {
    ...
    public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0) {
		...
		$fields = [
		    ...
		    'contact' => [
   			...
   			'data'=> [
				...
				'number_in_household'=> Yii::app()->request->getParam('number_in_household'),
		...
		if($age > 65){
			$apitoken = '03d69095c4aa113229b733cda81353d2ae451f4a';
		}else{
			$apitoken = '13d139397721da493806f639348f50f23f704711';
		}
    ...
    public static function sendPostData($p1, $p2, $p3, $ping_response, $post_url, $status) {
		...
		$total_inches = $height_cm/2.54;
		$height_feet = intval($total_inches/12);
		$height_inches = round($total_inches);
		$zip_code = Yii::app()->request->getParam('zip');
		$submission_model = new Submissions();
