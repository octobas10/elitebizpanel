	...
	public function actionIndex(){
		...
		if($affiliate_status!='TestMode'){
			if($affiliate_cap){
				...
				//echo '<pre>';print_r($multi_curl);echo '</pre>';exit;
				$ping_responses = $cm->multi_curl($multi_curl);
				//echo '<pre>';print_r($ping_responses);echo '</pre>';exit;
				/** ========================END=====================**/
				...
				if(!empty($static_price_lenderlist)){
					...
					foreach($static_price_lenderlist as $static_price_lender){
						...
						$ping_id = null;
						//$post_responses['post_price'] =  $static_lead_price > $post_responses['post_price'] ? $static_lead_price : $post_responses['post_price'];
