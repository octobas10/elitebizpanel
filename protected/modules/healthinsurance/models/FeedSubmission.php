 ...
 */
class FeedSubmission extends HealthinsuranceActive {
    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'healthinsurance_feed_submission';
    }
    ...
    public function getSubmissionData($delay, $limit, $commit_point) {
        ...
        $feed_submissions = Yii::app()->dbHealthinsurance->createCommand()->select('*')->from('healthinsurance_feed_submission')->where($where)->limit($limit)->queryAll();
