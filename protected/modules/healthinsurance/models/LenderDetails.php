<?php
/**
 * This is the model class for table "healthinsurance_lender_details".
 *
 * The followings are the available columns in table 'healthinsurance_lender_details':
 * @property integer $id
 ...
 */
class LenderDetails extends HealthinsuranceActive{
	/**   
	...
	public function tableName(){
		return 'healthinsurance_lender_details';
	}
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE healthinsurance_lender_details SET paused_vendor  = '$val' WHERE id=$id";
	...
	public function check_acceptCap($lender_id) {
		...
		$cmd = Yii::app()->dbHealthinsurance->createCommand()
			->select('submission_cap,accepted_cap,hourly_submission_cap')
			->from('healthinsurance_lender_details')
	...
	public function check_paused_vendor($lender_id){
		$where = "id= '$lender_id'";
		$array = Yii::app()->dbHealthinsurance->createCommand()
