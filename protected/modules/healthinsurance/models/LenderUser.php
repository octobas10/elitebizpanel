...
/**
 * This is the model class for table "healthinsurance_lender_user".
 *
 * The followings are the available columns in table 'healthinsurance_lender_user':
 * @property string $id
 ...
 */
class LenderUser extends HealthinsuranceActive{
	/**
	...
	public function tableName(){
		return 'healthinsurance_lender_user';
	}
