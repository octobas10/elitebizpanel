<?php
/**
 * This is the model class for table "healthinsurance_lender_affiliate_settings".
 *
 * The followings are the available columns in table 'healthinsurance_lender_affiliate_settings':
 * @property integer $id
 ...
 */
class LenderAffiliateSettings extends HealthinsuranceActive{
	/**
	...
	public function tableName(){
		return 'healthinsurance_lender_affiliate_settings';
	}
	...
	public function findcapoflender($id){
		return $cap = Yii::app()->dbHealthinsurance->createCommand()
	    ->select('cap')
	...
	public function actionPausevendorAjax(){
		...
		$sql = "UPDATE healthinsurance_lender_affiliate_settings SET paused_vendor  = '$val' WHERE id=$id";
