...
<![endif]-->
<title>elitehealthinsurers.com Affiliate Ping-Post Instructions</title>
<style type="text/css">
.red_api_navigation {
...
<body>
<div class="red_api_navigation">elitehealthinsurers.com – Elite Publisher Portal - Healthinsurance</div>
<div class="container">
<div class="content">
<div id="body_wrapper" style="margin-top: 0;">
<br /><br />
<div id="body">
<div class="aff_body">
<?php echo $content; ?>
...
Copyright &copy; <?php echo @date('Y'); ?> by EliteCashWire.com Inc.<br/>All Rights Reserved.<br/>
</div><!-- footer -->
</div>
</body>
</html>
