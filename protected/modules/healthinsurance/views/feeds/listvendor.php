...
$buttons = array(
			...
			'buttons'=>array(
				'view'=>
					array(					
						'url'=>'Yii::app()->createUrl("healthinsurance/feeds/viewvendor", array("id"=>$data->id))',								
					),
				'update'=>
					array(
						'url'=>'Yii::app()->createUrl("healthinsurance/feeds/updatevendor", array("id"=>$data->id))',
					),
				'delete'=>
					array(
						'url'=>'Yii::app()->createUrl("healthinsurance/feeds/deletevendor", array("id"=>$data->id))',
					),
			),
		);
?>
