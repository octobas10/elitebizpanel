...
<?php
	...
	$feevendor = AutoFeedVendor::model()->findAll($Criteria);
	$Criteria->select = "id,paused_vendor";
	$Criteria->condition = "id = ".$id;
	$lendor_pausedvendor = AutoFeedLenders::model()->findAll($Criteria);
...
$.ajax({
   type: 'GET',
   url: '<?php echo Yii::app()->createAbsoluteUrl("healthinsurance/autoFeedLenders/pausevendorAjax"); ?>',
