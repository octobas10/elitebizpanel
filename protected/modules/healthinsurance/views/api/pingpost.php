...
<table border="0" cellspacing="0" class="data">
    ...
    <tbody>
        ...
        <tr>
            <td class="mono">phone_last_4</td>
            <td>Last 4 digits of primary phone.
            <td class="txtcenter"><img class="inline" src="<?php echo Yii::app()->request->baseUrl; ?>/images/required.gif" width="16" height="16" alt="Required" title="Required"></td>
        </tr>
        <tr>
...
<h4>Ping Request Using  HTTP/1.1 POST </h4>
<p>Our testing address is <span class="mono">https:<?php echo Yii::app()->request->baseUrl; ?>/pingprocess</span>, and our live address is <span class="mono">https:<?php echo Yii::app()->request->baseUrl; ?>/pingprocess</span>. Please <strong>do not</strong> begin posting to the live address until our tech has manually verified your test data (in addition to our automatic validation process), <em>and</em> we've explicitly notified you that your campaign has been activated within our system. Any leads posted to the live address while your campaign is still in test mode will return an error and neither be counted nor returned.</p>

<h4>Example Request</h4>

<code style="height: 9.5em;">
    PING URL: https://elitebizpanel.com/healthinsurance/pingprocess<br>
    Accept: text/html<br>
    ...
    <tbody>
      ...
      <tr>
       ...
       <tr>
        ...
        <tr>
            <td class="mono">insurance_company</td>
            <td>Driver1's current insurance company <a href="#current_insurance_company"> Appendix : Current Insurance Companies</a><br>
                Note that we do NOT recommend a default mapping of '1' (Company Not Listed) for this field as doing so will result in very few leads being accepted.</td>
            <td class="txtcenter"><img class="inline" src="<?php echo Yii::app()->request->baseUrl; ?>/images/required.gif" width="16" height="16" alt="Required" title="Required"></td>
        </tr>
        <tr>
...
<h4>Example Request</h4>
<code style="height: 9.5em;">
    POST URL: https://elitebizpanel.com/healthinsurance/pingpostprocess<br>
    Accept: text/html<br>
