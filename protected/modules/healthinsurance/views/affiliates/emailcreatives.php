...
<p class="title">Elitehealthinsurance Email Creatives:</p>
...
<div class="row display_creatives">
<p class="title">Elitehealthinsurance Email Creatives Subject Lines:</p>
<?php 
...
<div class="row display_creatives">
<p class="title">Elitehealthinsurance Email Creatives From Lines:</p>
<?php
