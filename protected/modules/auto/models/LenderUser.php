...
/**
 * This is the model class for table "auto_lender_user".
 *
 * The followings are the available columns in table 'auto_lender_user':
 * @property string $id
 ...
 */
class LenderUser extends CActiveRecord{
	/**
