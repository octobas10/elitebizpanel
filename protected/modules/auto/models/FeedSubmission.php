 ...
 */
class FeedSubmission extends CActiveRecord {
    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'auto_feed_submission';
    }
    ...
    public function getSubmissionData($delay, $limit, $commit_point) {
        ...
        $feed_submissions = Yii::app()->db->createCommand()->select('*')->from('auto_feed_submission')->where($where)->limit($limit)->queryAll();
