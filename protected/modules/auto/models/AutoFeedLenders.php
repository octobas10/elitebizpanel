 ...
 */
class AutoFeedLenders extends CActiveRecord
{
	/**
	...
	public function getvendorslist(){
		extract($_REQUEST);
		$update = Yii::app()->db->createCommand()->update('auto_feed_lenders', array('paused_vendor'=>$val),'id=:id',array(':id'=>$id));
		if($val!=""){
			return $val;
		}
	...
	public function check_caps($feed_lender_name,$promo_code = false){
		...
		$feedlenderlist = Yii::app()->db->createCommand()
		...
		$intervalcount = Yii::app()->db->createCommand()
