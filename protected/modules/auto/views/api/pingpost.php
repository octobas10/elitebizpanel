...
<h2>Elite Auto Ping Post Specifications</h2>
<br>
<br>
<!-- ======= Ping: ======= -->
<h2>Ping : </h2>
...
<table class="data" border="0" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="txtcenter"><img class="inline" src="<?php echo Yii::app()->request->baseUrl; ?>/images/optional.gif" alt="Optional" title="Required" height="16" width="16"></td>
        </tr>
        <tr>
...
<p>Our testing address is <span class="mono">https://elitebizpanel.com/auto/pingprocess</span>, and our live address is <span class="mono">https://elitebizpanel.com/auto/pingprocess</span>. Please <strong>do not</strong> begin posting to the live address until our tech has manually verified your test data (in addition to our automatic validation process), <em>and</em> we've explicitly notified you that your campaign has been activated within our system. Any leads posted to the live address while your campaign is still in test mode will return an error and neither be counted nor returned.</p>
