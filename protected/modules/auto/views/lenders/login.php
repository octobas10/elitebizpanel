	...
	<div class="span6 offset3">
		<?php
			$this->beginWidget('zii.widgets.CPortlet', array(
				'title'=>"Lender Login Into EliteAutoCash.com Lender Portal",
			));
			?>
		...
		<div class="register_link">
			Are you a <a href="http://www.eliteautocash.com" target="_blank" class="sitelink">EliteAutoCash.com</a> Publisher <a href="../affiliates/login" class="affilaite_login"> Click Here</a>
		</div>
		</div>
		<?php $this->endWidget();?>
	</div>
