...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/auto/graph/submissionLast15Days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/auto/graph/conversionsoflast15days");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/auto/graph/lendersDailycountAccept");
...
<div class="row-fluid">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/auto/graph/hourlyacceptancerate");
...
<div class="row-fluid">
  <div class="span12">
	...
	chart.setDataURL("<?php echo Yii::app()->getBaseUrl(true); ?>/index.php/auto/graph/statewiseAcceptance");
