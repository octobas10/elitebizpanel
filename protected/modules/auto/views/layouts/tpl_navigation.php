<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<a class="brand" style="margin-left: 0px;" href="#">Elite Lead Management <?php echo $user_from_url;?> Portal</a>
			...
			$this->widget('zii.widgets.CMenu',array(
				...
				'items' => array(
					...
					array(
						'label' => 'Landing Page',
						'url' => 'http://eliteautocash.com/?promo_code='.$promo_code,
						'linkOptions' => array(
							'target' => '_blank',
						),
						'visible' => (Yii::app()->user->getState('roles')!='1'&&!Yii::app()->user->isGuest && Yii::app()->user->getState('usertype')=='affiliate'),
