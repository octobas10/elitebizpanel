...
<p class="title">EliteAutoCash Email Creatives:</p>
...
<div class="row display_creatives">
<p class="title">EliteAutoCash Email Creatives Subject Lines:</p>
<?php 
...
<div class="row display_creatives">
<p class="title">EliteAutoCash Email Creatives From Lines:</p>
<?php
