...
$buttons = array(
			...
			'buttons'=>array(
				'view'=>
					array(					
						'url'=>'Yii::app()->createUrl("auto/feeds/viewvendor", array("id"=>$data->id))',								
					),
				'update'=>
					array(
						'url'=>'Yii::app()->createUrl("auto/feeds/updatevendor", array("id"=>$data->id))',
					),
				'delete'=>
					array(
						'url'=>'Yii::app()->createUrl("auto/feeds/deletevendor", array("id"=>$data->id))',
					),
			),
		);
?>
