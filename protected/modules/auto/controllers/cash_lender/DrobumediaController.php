<?php
class DrobumediaController extends Controller {
	...
	public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0){
		...
		$pingData['header'] = array("Authorization: Token 14c11ce5dd61d14b638e61af23303e932b1c7f2e","Content-Type: application/xml");
	...
	public static function sendPostData($parameter1,$parameter2,$parameter3,$ping_response,$post_url,$status){
		...
		$header = array("Authorization: Token 14c11ce5dd61d14b638e61af23303e932b1c7f2e","Content-Type: application/xml");
