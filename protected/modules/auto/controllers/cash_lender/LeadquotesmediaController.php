<?php
class LeadquotesmediaController extends Controller {
	...
	public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0){
		$pingData = array();
		$LeadIDCode=!empty($p1) ? $p1 : 'ap002419';
		$OfferID=!empty($p2) ? $p2 : Yii::app()->request->getParam('promo_code');
		...
		$pingData['header'] = array("Authorization: Token dd40348ce6a4c13b83ad238143eb3f9d08b2d201","Content-Type: application/xml");
	...
	public static function sendPostData($parameter1,$parameter2,$parameter3,$ping_response,$post_url,$status){
		...
		//$header = array("api-authentication: dd40348ce6a4c13b83ad238143eb3f9d08b2d201","Content-Type: application/xml");
		$header = array("Authorization: Token dd40348ce6a4c13b83ad238143eb3f9d08b2d201","Content-Type: application/xml");
