<?php
class WhatifmediagroupController extends Controller {
	...
	public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0){
		...
		$token = !empty($p1) ? $p1 : '4b0f2f059198c4de0bc6c8d91447aaaf8b0a1f02';
		...
		$pingData['header'] = array("Authorization: Token $token","Content-Type: application/xml");
	...
	public static function sendPostData($parameter1,$parameter2,$parameter3,$ping_response,$post_url,$status){
		...
		$token = !empty($parameter1) ? $parameter1 : '4b0f2f059198c4de0bc6c8d91447aaaf8b0a1f02';
		...
		$header = array("Authorization: Token $token","Content-Type: application/xml");
