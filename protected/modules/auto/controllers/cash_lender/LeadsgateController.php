<?php
class LeadsgateController extends Controller {
	...
	public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0){
		...
		$pingData['header'] = array("Authorization: Token b6433fcc7a2200e29336e4d622cb83d45e2a66d6","Content-Type: application/xml");
	...
	public static function sendPostData($parameter1,$parameter2,$parameter3,$ping_response,$post_url,$status){
		...
		//$header = array("api-authentication: b6433fcc7a2200e29336e4d622cb83d45e2a66d6","Content-Type: application/xml");
		$header = array("Authorization: Token b6433fcc7a2200e29336e4d622cb83d45e2a66d6","Content-Type: application/xml");
