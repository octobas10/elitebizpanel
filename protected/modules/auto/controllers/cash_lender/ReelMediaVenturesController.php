<?php
class ReelMediaVenturesController extends Controller {
	...
	public static function returnPingData($p1 = false, $p2 = false, $p3 = false, $status = 0){
		...
		$OfferID = Yii::app()->session['affiliate_trans_id'];
		...
		$pingData['header'] = array("Authorization: Token 96da7ba02814e15c8835cd6cacc1d8bf1400b57d","Content-Type: application/xml");
	...
	public static function sendPostData($parameter1,$parameter2,$parameter3,$ping_response,$post_url,$status){
		...
		$header = array("Authorization: Token 96da7ba02814e15c8835cd6cacc1d8bf1400b57d","Content-Type: application/xml");
