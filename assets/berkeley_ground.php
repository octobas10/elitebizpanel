...
$campus_code = ['NYC','NWK','MDL','GMT'];
//$campus_code = ['NYC','MDL','GMT'];
// New York City
$campus_NYC = ['AAS_AC','AAS_MG','AAS_CJ','BBA_FN','BBA_GB','BBA_HM','BBA_MK','BS_TM','BBA_AC','BBA_MG','BS_CJ','AAS_FN','AAS_MK','AAS_TM'];
// Newark
$campus_NWK = ['AAS_MG','AAS_CJ','AAS_MD','C_PCT'];
// Woodbridge
$campus_MDL = ['AAS_MG','AAS_CJ','AAS_MD','BBA_FN','BBA_GB','BBA_HM','BBA_MK','BS_TM','BBA_MG','BS_CJ','AAS_FN','AAS_MK','AAS_TM'];
// Woodland Park
$campus_GMT = ['AAS_AC','AAS_MG','AAS_CJ','AAS_MD','BBA_FN','BBA_GB','BBA_HM','BBA_MK','BS_TM','C_PCT'];
