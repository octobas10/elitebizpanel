...
?>
Action : https://<?php echo $_SERVER['HTTP_HOST'] .$link;?>/index.php/businessloans/pingpostprocess

<form method="POST" action="http://<?php echo $_SERVER['HTTP_HOST'] .$link;?>/index.php/businessloans/pingpostprocess" enctype="multipart/form-data" target="_blank">
