<html>
    ...
    <?php
        ...
        ?>
        Action : <?php echo $channel;?>://<?php echo $_SERVER['HTTP_HOST'] .$link;?>/index.php/autoinsurance/pingprocess

        <form method="POST" action="<?php echo $channel;?>://<?php echo $_SERVER['HTTP_HOST'] .$link;?>/index.php/autoinsurance/pingprocess" enctype="multipart/form-data" target="_blank">
...
-->              
                ...
                <tr>
                    <td>driver1_dob</td>
                    <td><input type="text" value="1979-10-10" name="driver1_dob" placeholder="YYYY-MM-DD" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="driver1_incident2_date" value="<?php echo date('Y-m-d',time()-(86400*45))?>" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="driver2_incident1_date" value="<?php echo date('Y-m-d',time()-(86400*12))?>" />
                    </td>
                </tr>
                <tr>
                    <td>driver2_ticket1_description</td>
                    <td>
                        <input type="text" name="driver2_ticket1_description" value="1" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>driver2_num_of_incidents</td>
                    <td>
                        <input type="text" name="driver2_num_of_incidents" value="2" />
                    </td>
                </tr>
                ...
                <tr>
                    <td>driver2_incident2_type</td>
                    <td>
                        <input type="text" name="driver2_incident2_type" value="1" />
                    </td>
                </tr>
                <tr>
                    <td>driver2_incident2_date</td>
                    <td>
                        <input type="text" name="driver2_incident2_date" value="<?php echo date('Y-m-d')?>" />
                    </td>
                </tr>
                <tr>
                    <td>driver2_ticket2_description</td>
                    <td>
                        <input type="text" name="driver2_ticket2_description" value="1" />
                    </td>
                </tr>
            ...
            <a target="_blank" href="pingpost_post.php">Send Post For this Ping, If you get success response on ping</a>
        </form>
