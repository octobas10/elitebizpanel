<html>
    ...
    <body>
        Action : index.php/autoinsurance/pingprocess
		
        <form method="POST" action="/../../index.php/autoinsurance/pingprocess" enctype="multipart/form-data" target="_blank">
            ...
            <table>
				...
				<tr>
                    <td>lender</td>
                    <td><input type="text" value="AstoriaCompany" name="lender" /></td>
                </tr>
                <tr>
                    <td>ipaddress</td>
