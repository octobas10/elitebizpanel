...
foreach ($campus_code as $campus){
	...
	foreach ($$my_array as $program){
		$sql = "SELECT DISTINCT postal_Code,ECW_Program_code FROM berkeley_active_zipcode_campus WHERE `program_code` ='$program' AND `campus_code` ='$campus'";
...
// ===> BERKELEY_GROUND_CAMPUS_ZIPCODES_DECEMBER_2024.txt
...
// ===> BERKELEY_ONLINE_NJ_CAMPUS_ZIPCODES_DECEMBER_2024.txt (NJ)
...
//--- BERKELEY_ONLINE_NY_CAMPUS_ZIPCODES_DECEMBER_2024.txt
