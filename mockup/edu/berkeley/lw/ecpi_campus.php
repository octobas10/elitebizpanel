...
load data local infile '/Users/vipulbhandari/Downloads/ECPI.tsv' into table ecpi_active_zipcode_campus fields terminated by '\t' enclosed by '"' escaped by '\\' lines terminated by '\n' ignore 1 rows;
...
select DISTINCT code from program_of_interest_quinstreet_ecpi where QMP_program_code IN ('BSN','CLOUDCOM','CYBNETSY','EET','EETBS','HCADMIN','MECHASSO','MECHATRO','MEDASST','MOBDEV','PRACNURS','RN','SOFTDEVE','ACCOUNT','BSBA','CJCIA','CRJBS','DMS','ESET','ESETMEC','HOMELAND','DENTAL','MEDRAD','SURTECH','ACLBSN','PHYTHER','ITMGMT','MET','META','PAMEDIC');
